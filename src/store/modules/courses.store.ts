...
const state: CoursesState = {
    courses: [
        { id: '1', dateCompleted: new Date(), name: 'The Course' },
        { id: '2', dateCompleted: new Date(), name: 'The Second Course' },
        { id: '3', dateCompleted: new Date(), name: 'The Third Course' },
        { id: '4', dateCompleted: new Date(), name: 'The Fourth Course' }
    ] as Course[]
};
...
const mutations = {
    setCourses: (state: CoursesState, courses: Course[]) => (state.courses = cloneDeep(courses)),
